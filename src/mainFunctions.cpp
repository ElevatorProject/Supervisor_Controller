...
int chooseID() {
    ...
    while (1) {
        ...
        printf("1. Message from Supervisory controller (i.e. this node) to "
               "Elecvator Controller\n");
        printf("2. Message from Elevator controller to all other nodes\n");
        printf("3. Message from Car controller to supervisory controller (this "
               "node)\n");
        printf("4. Message from floor 1 controller to supervisory controller "
               "(this "
               "node)\n");
        printf("5. Message from floor 2 controller to supervisory controller "
               "(this "
               "node)\n");
        printf("6. Message from floor 3 controller to supervisory controller "
               "(this "
               "node)\n");
